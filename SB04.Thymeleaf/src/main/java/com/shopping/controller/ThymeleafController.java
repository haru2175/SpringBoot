...
public class ThymeleafController {
    ...
    public String thymeleafExample02(Model model){
        ...
        return "thymeleafEx/viewEx02"; // 해당 페이지로 이동하겠습니다.
    }
    @GetMapping(value = "ex03")
    public String thymeleafExample03(Model model){
        List<Product> beanList = GenerateData.getProductList(10);
        model.addAttribute("beanList",beanList);
        return "thymeleafEx/viewEx03"; // 해당 페이지로 이동하겠습니다.
    }
    @GetMapping(value = "ex04")
    public String thymeleafExample04(Model model){
        List<Product> beanList = GenerateData.getProductList(10);
        model.addAttribute("beanList",beanList);
        return "thymeleafEx/viewEx04"; // 해당 페이지로 이동하겠습니다.
    }
    @GetMapping(value = "ex05")
    public String thymeleafExample05(Model model){
        List<Product> beanList = GenerateData.getProductList(10);
        model.addAttribute("beanList",beanList);
        return "thymeleafEx/viewEx05"; // 해당 페이지로 이동하겠습니다.
    }
    @GetMapping(value = "ex06")
    public String thymeleafExample06(Model model){
        return "thymeleafEx/viewEx06"; // 해당 페이지로 이동하겠습니다.
    }
    ...
    public String thymeleafExample07(String param1,String param2,Model model){
        ...
        return "thymeleafEx/viewEx07"; // 해당 페이지로 이동하겠습니다.
    }
    @GetMapping(value = "layout")
    public String thymeleafExampleLayout(){
        return "thymeleafEx/pageLayout"; // 해당 페이지로 이동하겠습니다.
    }
